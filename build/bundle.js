...
var app = (0, _express2.default)(); // Note: we can do this because we're using webpack on all of our code, including our server.
...
var Home = function Home(props) {
  ...
  var originString = props.isClient ? 'server' : 'client';
  var divStyle = {
    'backgroundColor': 'orangered',
    'color': 'white'
  };
  var displayString = 'I\'m the EVEN BETTER home component: ' + originString;
